...
| Date | Change | Author |
|------|--------|--------|
| 2026-02-03 | Initial implementation of confidence-based abstention | Claude/Cem |
| 2026-02-03 | Added return_metadata to all Weaviate queries | Claude |
| 2026-02-03 | Added hallucination detection to test runner | Claude |
| 2026-02-03 | Created RAG diagnostic framework | Claude |
