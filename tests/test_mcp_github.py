...
from aion.mcp.github import parse_github_url
from aion.mcp.registry import _servers, get_server, load_registry
...
class TestGetFileContents:
    ...
    async def test_fetch_file(self):
        from aion.mcp.github import get_file_contents
...
class TestGetRepoReadme:
    ...
    async def test_fetch_readme(self):
        from aion.mcp.github import get_repo_readme
...
class TestListDirectory:
    ...
    async def test_list_root(self):
        from aion.mcp.github import list_directory
...
class TestGetRepoMetadata:
    ...
    async def test_get_metadata(self):
        from aion.mcp.github import get_repo_metadata
...
class TestGetOrgOverview:
    ...
    async def test_get_org(self):
        from aion.mcp.github import get_org_overview
...
class TestFetchGithubContent:
    ...
    async def test_readme_truncation(self):
        ...
        with patch("aion.mcp.github.get_repo_metadata", new_callable=AsyncMock, return_value="desc"), \
             patch("aion.mcp.github.get_repo_readme", new_callable=AsyncMock, return_value=long_readme), \
             patch("aion.mcp.github.list_directory", new_callable=AsyncMock, return_value="dir"):
