...
Usage:
    python -m aion.diagnostics.retrieval_inspector "What is a switchgear?"
    python -m aion.diagnostics.retrieval_inspector --all-tests
"""
...
from aion.ingestion.client import get_weaviate_client as get_client
...
def main():
    ...
    if not args.question:
        parser.print_help()
        print("\nExample usage:")
        print('  python -m aion.diagnostics.retrieval_inspector "What is a switchgear?"')
        print('  python -m aion.diagnostics.retrieval_inspector "Why Kafka?" -c ArchitecturalDecision')
        print('  python -m aion.diagnostics.retrieval_inspector "API principles" --compare-alpha')
        print('  python -m aion.diagnostics.retrieval_inspector --all-tests')
        return
