...
class GenerationPipeline:
    ...
    def _get_registry_prompt_limit() -> int:
        ...
        try:
            ...
            logger.warning("Failed to read registry prompt_limit from thresholds, using default 30")
        return 30
...
async def stream_synthesis_response(
    ...
    if provider in ("github_models", "openai"):
        ...
        async with AsyncOpenAI(**settings.get_openai_client_kwargs(
            ...
            from aion.skills.loader import get_thresholds_value as _gtv
            _token_limits = _gtv("get_llm_token_limits", {})
