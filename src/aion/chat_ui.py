...
from aion.routing import ExecutionModel, _has_kb_skill_tags
...
async def stream_document_analysis_response(
    ...
    """Stream DocumentAnalysisAgent's response as SSE events."""
    def factory(output_queue):
        return _document_agent.query(
    ...
    async for event in _stream_agent_response(
        factory, label="Document Analysis",
        initial_status="Analyzing uploaded document...",
        agent_key="document_agent",
    ):
        yield event
