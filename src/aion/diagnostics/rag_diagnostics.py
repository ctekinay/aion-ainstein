...
Usage:
    python -m src.aion.diagnostics.rag_diagnostics --analyze-chunks
    python -m src.aion.diagnostics.rag_diagnostics --test-retrieval
    python -m src.aion.diagnostics.rag_diagnostics --tune-alpha
    python -m src.aion.diagnostics.rag_diagnostics --full-diagnostic
"""
...
def main():
    ...
    if args.analyze_chunks:
        ...
        parser.print_help()
        print("\nExamples:")
        print("  python -m src.aion.diagnostics.rag_diagnostics --analyze-chunks")
        print("  python -m src.aion.diagnostics.rag_diagnostics --test-retrieval")
        print('  python -m src.aion.diagnostics.rag_diagnostics --tune-alpha -q "What is CIM?"')
        print("  python -m src.aion.diagnostics.rag_diagnostics --full-diagnostic")
