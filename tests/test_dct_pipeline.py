...
from src.aion.chunking.models import ChunkMetadata
...
class TestEnrichYamlDctExtended:
    def test_issued_and_language_in_enriched_yaml(self):
        ...
        result = GenerationPipeline._enrich_yaml_with_dct(yaml_input, metadata)
    ...
    def test_uuid_mismatch_logs_warning(self, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="src.aion.generation"):
            GenerationPipeline._enrich_yaml_with_dct(yaml_input, metadata)
