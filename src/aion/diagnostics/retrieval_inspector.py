...
Usage:
    python -m src.aion.diagnostics.retrieval_inspector "What is a switchgear?"
    python -m src.aion.diagnostics.retrieval_inspector --all-tests
"""
...
def main():
    ...
    if not args.question:
        parser.print_help()
        print("\nExample usage:")
        print('  python -m src.aion.diagnostics.retrieval_inspector "What is a switchgear?"')
        print('  python -m src.aion.diagnostics.retrieval_inspector "Why Kafka?" -c ArchitecturalDecision')
        print('  python -m src.aion.diagnostics.retrieval_inspector "API principles" --compare-alpha')
        print('  python -m src.aion.diagnostics.retrieval_inspector --all-tests')
        return
