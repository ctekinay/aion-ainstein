...
- ApplicationComponent/Function/Service → Requirement, Constraint (core realizes motivation)
- BusinessProcess/Function/Service → Requirement, Goal, Outcome (core realizes motivation)
- Node/SystemSoftware → Requirement (technology realizes motivation)
