...
| # | Task | Details | Status |
|---|------|---------|--------|
| 1.1 | Create new branch | `git checkout -b feature/skills-framework` | [x] |
...
|---|------|----------------|-------------|--------|
| 2.1 | Create skills directory | `skills/` | Root directory for all skills | [x] |
| 2.2 | Create RAG quality skill folder | `skills/rag-quality-assurance/` | First skill | [x] |
| 2.3 | Create main skill file | `skills/rag-quality-assurance/SKILL.md` | YAML frontmatter + behavioral rules | [x] |
| 2.4 | Create references folder | `skills/rag-quality-assurance/references/` | Supporting config files | [x] |
| 2.5 | Create thresholds config | `skills/rag-quality-assurance/references/thresholds.yaml` | Abstention thresholds, retrieval limits | [x] |
| 2.6 | Create skills registry | `skills/registry.yaml` | Skill metadata, activation triggers | [x] |
...
|---|------|------|-------------|--------|
| 3.1 | Create skills package | `src/skills/__init__.py` | Package exports | [x] |
| 3.2 | Create skill loader | `src/skills/loader.py` | Parse SKILL.md, load references, extract thresholds | [x] |
| 3.3 | Create registry manager | `src/skills/registry.py` | Read registry.yaml, manage skill activation | [x] |
...
|---|------|------|--------------|--------|
| 4.1 | Inject skills into main prompt | `src/elysia_agents.py` | Line ~652: System prompt becomes skill-injectable | [x] |
| 4.2 | Inject skills into OpenAI comparison prompt | `src/chat_ui.py` | Line 951: OpenAI prompt becomes skill-injectable | [x] |
| 4.3 | Inject skills into Ollama comparison prompt | `src/chat_ui.py` | Line 955: Ollama prompt becomes skill-injectable | [x] |
...
| # | Task | File | What Changes | Status |
|---|------|------|--------------|--------|
| 5.1 | Remove hardcoded `DISTANCE_THRESHOLD` | `src/elysia_agents.py` | Line 17: Load from skill config | [x] |
| 5.2 | Remove hardcoded `MIN_QUERY_COVERAGE` | `src/elysia_agents.py` | Line 18: Load from skill config | [x] |
| 5.3 | Remove hardcoded retrieval limits | `src/chat_ui.py` | Lines 691-694: Load from skill config | [x] |
| 5.4 | Update `should_abstain()` | `src/elysia_agents.py` | Use skill-loaded thresholds | [x] |
...
|---|------|-------------|--------|
| 6.1 | Test skill parsing | Verify SKILL.md YAML frontmatter + markdown body parsed correctly | [x] |
| 6.2 | Test threshold loading | Verify thresholds loaded from `references/thresholds.yaml` | [x] |
| 6.3 | Test prompt injection | Verify skill rules appear in system prompts | [x] |
| 6.4 | Test abstention logic | Verify `should_abstain()` works with externalized thresholds | [x] |
| 6.5 | Test comparison mode | Verify both OpenAI and Ollama prompts get skill injection | [x] |
...
| # | Task | File | Description | Status |
|---|------|------|-------------|--------|
| 7.1 | Update ADR | `docs/decisions/ADR-xxxx-confidence-based-abstention...md` | Document skills implementation | [x] |
| 7.2 | Add skills README | `skills/README.md` | How to create/edit skills (for non-devs) | [x] |
...
| # | Task | Description | Status |
|---|------|-------------|--------|
| 8.1 | Commit changes | Clear commit message describing skills framework | [x] |
| 8.2 | Push to branch | `git push -u origin feature/skills-framework` | [x] |
...
|-------|-------|--------|--------|
| Phase 1: Setup | 1 | Low | [x] |
| Phase 2: Skills Directory | 6 | Low | [x] |
| Phase 3: SkillLoader Module | 3 | Medium | [x] |
| Phase 4: Prompt Injection | 3 | Medium | [x] |
| Phase 5: Threshold Externalization | 4 | Medium | [x] |
| Phase 6: Testing | 5 | Medium | [x] |
| Phase 7: Documentation | 2 | Low | [x] |
| Phase 8: Commit & Push | 2 | Low | [x] |
| **Total** | **26 tasks** | | |
