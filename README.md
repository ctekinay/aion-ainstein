...
└── repo-architecture-explorer/     # On-demand (tag: repo-architecture-explorer)
    ├── SKILL.md                     # Interactive HTML explorer generation rules
    └── references/
        └── EXPLORER_TEMPLATE.md     # Complete HTML/CSS/JS template spec
```
