...
**Before answering any domain question, search each key domain term individually in Skosmos.** Do not skip terms you think you already know. Do not batch terms into a single search. One term per `skosmos_search` call.
