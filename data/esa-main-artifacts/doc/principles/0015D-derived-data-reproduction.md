...
## 2. Using PCP.15 in collaboration GridScaleX & GaaS development with Siemens

| Name                 | Value                                                        |
| -------------------- | ------------------------------------------------------------ |
| Version of principle | v1.0.0 (2025-10-27)                                          |
| Decision             | Supported                                                    |
...
**Additional Notes**
Decision is to fully support the principle as presented during decision date. Bringing to [acceptance] state under investigation but depending on governance processes Siemens AG widely.

---
## 1. Creation and ESA Approval of PCP.15
