...
from src.aion.chat_ui import _query_references_artifact
...
class TestQueryReferencesArtifact:
    ...
    def test_archimate_follow_up_no_keywords(self):
        artifact = {"content_type": "archimate/xml"}
        assert _query_references_artifact("what ADRs exist?", "follow_up", artifact) is False
    ...
    def test_yaml_artifact_no_keywords(self):
        artifact = {"content_type": "text/yaml"}
        assert _query_references_artifact("what ADRs exist?", "follow_up", artifact) is False
