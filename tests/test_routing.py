...
@pytest.mark.parametrize("intent,expected", [
    ...
    # Phase 0d: conversational was previously a direct-response
    # intent (bypassed routing entirely). It now routes through RAG so the
    # answer is grounded in the KB rather than synthesised from training
    # data. With no skill_tags it falls through to ExecutionModel.TREE
    # at routing.py:~186 — the documented default RAG path.
    ("conversational", ExecutionModel.TREE),
])
