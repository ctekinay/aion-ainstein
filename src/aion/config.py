    ...
    def build_pydantic_ai_model(self, component: str = "rag"):
        ...
        if provider == "ollama":
            client = AsyncOpenAI(
                ...
                api_key="ollama",
                max_retries=self.openai_max_retries,
                timeout=httpx.Timeout(self.timeout_agent_multi_tool, connect=10.0),
            )
            ...
            kwargs = self.get_openai_client_kwargs("github_models", timeout=self.timeout_agent_multi_tool)
