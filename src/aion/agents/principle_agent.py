...
def _build_principle_agent(toolkit: RAGToolkit) -> Agent[SessionContext, str]:
    ...
    def list_all_principles(ctx_: RunContext[SessionContext]) -> list[dict]:
        ...
        try:
            ...
            logger.exception("list_all_principles error")
            return [{"error": str(e)}]
...
class PrincipleAgent:
    ...
    Tools:
      ...
      3. list_all_principles — enumerate all principles for broad assessment
    ...
    def _build_system_prompt(skill_content: str, artifact_context: str | None) -> str:
        ...
        parts.extend([
            ...
            "- For ASSESSMENT: use search_principles or list_all_principles to fetch the "
