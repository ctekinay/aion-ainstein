...
class TestEnrichYamlWithDct:
    ...
    def test_explicit_source_ref(self):
        ...
        result = enrich_yaml_with_dct(yaml_input, self.METADATA)
    ...
    def test_malformed_yaml_returns_original(self):
        ...
        bad_yaml = "elements:\n  - id: [broken yaml"
        result = enrich_yaml_with_dct(bad_yaml, self.METADATA)
    ...
    def test_empty_metadata_strips_source_ref(self):
        ...
        result = enrich_yaml_with_dct(yaml_input, {})
        data = yaml.safe_load(result)
    ...
    def test_no_creator_when_absent(self):
        ...
        result = enrich_yaml_with_dct(yaml_input, meta)
        data = yaml.safe_load(result)
    ...
    def test_observability_logging(self, caplog):
        ...
        import logging
        with caplog.at_level(logging.INFO, logger="aion.tools.reconciliation"):
            enrich_yaml_with_dct(yaml_input, self.METADATA)
...
class TestEnrichmentXmlRoundTrip:
    ...
    def test_enriched_yaml_produces_valid_xml(self):
        ...
        # Enrich
        enriched = enrich_yaml_with_dct(yaml_input, metadata)
