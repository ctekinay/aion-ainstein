...
def _build_archimate_agent(mcp_tools=None) -> Agent[SessionContext, str]:
    """Build the Pydantic AI agent with ArchiMate + artifact tools + any plugin MCP tools."""
...
class ArchiMateAgent:
    ...
    def __init__(self, mcp_tools=None):
        self._agent = _build_archimate_agent(mcp_tools=mcp_tools)
    ...
    async def query(
        ...
        logger.info("archimate_agent_model model=%s", self._agent.model.model_name)
