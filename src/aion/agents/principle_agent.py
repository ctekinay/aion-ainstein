...
def _build_principle_agent(toolkit: RAGToolkit, mcp_tools=None) -> Agent[SessionContext, str]:
    """Build the Pydantic AI agent with principle + artifact tools + any plugin MCP tools."""
...
class PrincipleAgent:
    ...
    def __init__(self, client: WeaviateClient, mcp_tools=None):
        ...
        self._agent = _build_principle_agent(self.toolkit, mcp_tools=mcp_tools)
    ...
    async def query(
        ...
        _agent_cfg = get_runtime_value("agents", {})
