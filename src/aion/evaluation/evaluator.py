...
class RAGEvaluator:
    ...
    def __init__(
        ...
        base_url: str = f"http://127.0.0.1:{settings.server_port}",
    ):
    ...
    async def run_single_query(
        ...
        try:
            async with httpx.AsyncClient(timeout=settings.timeout_agent_multi_tool) as client:
        ...
        result.total_latency_ms = elapsed_ms(start_time)
